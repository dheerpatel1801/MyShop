...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "dheerpatel@gmail.com", ZipCode = "123456" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("dheerpatel@gmail.com", "Forms"), null);
